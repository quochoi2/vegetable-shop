            ...
            <div className="mt-4">
              ...
              <div className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                  ...
                  <span className="text-sm">lượt đăng</span>
                </div>
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    928K
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                Rất vui vì được gặp các bạn ở đây, mình tên là Hội, mình đến từ Việt Nam. Ngay từ nhỏ mình rất thích và ngưỡng mộ tình người của dân tộc Kinh. Lần này mình tham gia vào lớp này với mục đích hiểu rõ hơn về con người Kinh. Rất mong chúng ta sẽ có những buổi học thú vị, vui vẻ.
                </p>
              </div>

              <div className="mt-6.5">
                <h4 className="mb-3.5 font-medium text-black dark:text-white">
                  Theo dõi tôi trên nền tảng
                </h4>
